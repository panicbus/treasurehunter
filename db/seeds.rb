...
#   Mayor.create(name: 'Emanuel', city: cities.first)
    ...
    users = User.create([
        {username: 'James', email: 'jamestreasurehunter@gmail.com', password: '11111111'},
    ...
    hunt_users = HuntUser.create([
        ...
        {hunt_id: 1, user_id: 3, role: 'hunter', progress: 1},
        {hunt_id: 1, user_id: 4, role: 'huntmaster', progress: 99},
        {hunt_id: 2, user_id: 4, role: 'hunter', progress: 1},
        {hunt_id: 2, user_id: 5, role: 'hunter', progress: 2},
        {hunt_id: 2, user_id: 3, role: 'hunter', progress: 4},
        {hunt_id: 2, user_id: 1, role: 'huntmaster', progress: 99},
      ])
